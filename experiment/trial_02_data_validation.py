...
# #         self.config = config
# #         logger.info(f"Data Validation initialized")  
# #         logger.debug(f"Data validation config: {self.config}") 


# #     def validate_columns(self, data:pd.DataFrame) -> Dict[str, Any]:
# #         """
...
# #         Returns:
# #         - dict: A dictionary with keys 'status' and 'message'. 'status' is a boolean indicating success or failure,
# #                 and 'message' is a dictionary with details of missing or extra columns if validation fails.
# #         """
# #         try:
...
# #                 logger.error(f"Column validation failed: {error_message}") 
# #                 return {"status": False, "message": error_message}
# #             logger.info(f"Column validation passed") 
# #             return {"status": True, "message": error_message}
# #         except Exception as e:
# #             logger.error(f"An error occurred during column validation: {e}")
...
# #             if invalid_values:
# #                 logger.error(f"String value validation failed: {invalid_values}") 
# #                 return False, invalid_values
# #             logger.info(f"String value validation passed") 
# #             return True, None
# #         except Exception as e:
# #             logger.exception(f"An error occurred during string value validation: {e}")
# #             return False, None
...
#       self._generate_profile_report(data, report_path)
#       logger.info(f"Data profile report saved to {report_path}")
...
#     # def _generate_profile_report(self, data: pd.DataFrame, report_path: Path):
#     #    """Generates a pandas profile report"""
#     #    try:
#     #       profile = ProfileReport(data, title = "Data Profiling Report")
#     #       profile.to_file(report_path)
#     #    except Exception as e:
#     #        logger.error(f"Error generating or saving pandas profile report: {e}")
#     #        raise CustomException(e, sys)
#     def _generate_profile_report(self, data: pd.DataFrame, report_path: Path):
#         """Generates a pandas profile report"""
#         try:
