...
DATA_TRANSFORMATION_CONFIG_FILEPATH = Path("config/data-transformation.yaml")
MODEL_TRAINER_CONFIG_FILEPATH = Path("config/model-trainer.yaml")
PARAMS_CONFIG_FILEPATH = Path("config/model-params.yaml")
MODEL_EVALUATION_CONFIG_FILEPATH = Path("config/model-evaluator.yaml")
MODEL_VALIDATION_CONFIG_FILEPATH = Path("config/model-validation.yaml")
PREDICTION_PIPELINE_CONFIG_FILEPATH = Path("config/model-predictor.yaml")